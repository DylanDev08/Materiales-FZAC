...
const addressSchema = z
  .object({
    placeId: z.string({ required_error: "Seleccioná una dirección sugerida por Google Maps." }).trim().min(10, "Seleccioná una dirección sugerida por Google Maps.").max(256, "La referencia de Google Maps es inválida."),
